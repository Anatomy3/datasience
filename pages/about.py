    ...
    return html.Div([
        ...
        dbc.Container([
            dbc.Row([
                dbc.Col([
                    html.Div([
                        html.H1("About Our Team", className="display-5 fw-bold mb-3"),
                        html.P("Meet the team behind this Data Science Salaries Dashboard project",
        ...
        dbc.Container([
            ...
            dbc.Row([
                dbc.Col([
                    html.H3("Team Members", className="text-center mb-4", style={'color': colors['primary']})
                ])
            ]),
            ...
            dbc.Row([
                dbc.Col([
                    create_team_member_card(
                        "Lingga Dwi Satria Vigio", "Data Science Student",
                        "08580590809", "Team Member",
                        ["Team Member", "Python", "Machine Learning"],
                        "lingga@student.com",
                        "https://linkedin.com/in/lingga",
                        "https://github.com/lingga",
                        colors['primary']
                    )
                ], md=6, lg=6, className="mb-4"),
                
                dbc.Col([
                    create_team_member_card(
                        "Azzahara Tunisyah", "Data Science Student", 
                        "Team Member", "Team Member",
                        ["Team Member", "Data Analysis", "Visualization"],
                        "azzahara@student.com",
                        "https://linkedin.com/in/azzahara", 
                        "https://github.com/azzahara",
                        colors['secondary']
                    )
                ], md=6, lg=6, className="mb-4")
            ], justify="center"),
        ...
        # Full-Width Contact Section - BACKGROUND HIJAU
        html.Div([
            dbc.Container([
                dbc.Row([
                    dbc.Col([
                        html.Div([
                            html.H2("Contact Us for help now", 
                                   className="text-white fw-bold mb-4 text-center"),
                            dbc.Button("CONTACT US", 
                                     color="light", 
                                     outline=True,
                                     className="btn-lg",
                                     style={
        ...
        html.Footer([
            dbc.Container([
                dbc.Row([
                    dbc.Col([
                        html.P([
                            "© 2023 Kelompok 6 Data Science. All rights reserved. | ",
                            html.Strong("Final Project Dashboard"),
                            " | Built with ❤️ using Python & Dash"
                        ], className="text-center text-light mb-0 small")
                    ])
                ])
            ...
            dbc.Row([
                dbc.Col([
                    html.Div([
                        ...
                        html.P([
                            "Data Science Salaries Dashboard adalah project akhir mata kuliah Data Science ",
                            "yang bertujuan untuk menganalisis tren gaji data scientist secara komprehensif. ",
                            "Project ini mengkombinasikan exploratory data analysis, machine learning, ",
                            "dan interactive web dashboard untuk memberikan insights yang actionable."
                        ], className="mb-3", style={'textAlign': 'justify'}),
                        
                        html.P([
                            "Melalui dashboard ini, kami menghadirkan analisis end-to-end dari data preprocessing ",
                            "hingga model deployment, dilengkapi dengan storytelling yang menarik dan ",
                            "visualisasi interaktif yang user-friendly."
